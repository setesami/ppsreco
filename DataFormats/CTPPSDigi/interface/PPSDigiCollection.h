#ifndef DataFormats_PPSDigiCollection_h
#define DataFormats_PPSDigiCollection_h

/**
 * \file
 * inheritate from class MuonDigiCollection
...
/**
 * \class DigiContainerIteratorAdaptor PPSDigiCollection.h "/PPSDigiCollection.h"
 * 
...
/**
 * \class PPSDigiCollection PPSDigiCollection.h "/PPSDigiCollection.h"
 *
 ...
 *
 *   \code
 *   typedef PPSDigiCollection<DetId,DTDigi> PPStimingDigiCollection
 *   \endcode
 *
 *   \note: Requirements
...
template <typename IndexType, 
	  typename DigiType>
class PPSDigiCollection {
  
public:

  PPSDigiCollection(){}

//  void swap(PPSDigiCollection<IndexType,DigiType> & rh) { std::swap(data_,rh.data_);}
  void swap(PPSDigiCollection & rh) { std::swap(data_,rh.data_);}
...
template <typename IndexType,
          typename DigiType>
inline
void swap(PPSDigiCollection<IndexType,DigiType> & rh,
          PPSDigiCollection<IndexType,DigiType> & lh){ rh.swap(lh);}
